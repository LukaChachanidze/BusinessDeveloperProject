...
namespace BusinessToDeveloper.Infrastructure.Migrations
{
    ...
    [Migration("20221210002406_application user")]
            ...
            modelBuilder.Entity("BusinessToDeveloper.Core.Entities.Developer", b =>
                {
                    ...
                    b.HasAlternateKey("Email")
                        .HasName("AlternateKey_Developer_Email");
            ...
            modelBuilder.Entity("BusinessToDeveloper.Core.Entities.Project", b =>
                {
                    b.HasOne("BusinessToDeveloper.Core.Entities.Business", "Business")
                        .WithOne()
                        .HasForeignKey("BusinessToDeveloper.Core.Entities.Project", "BusinessId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("ForeignKey_BusinessId");

                    b.HasOne("BusinessToDeveloper.Core.Entities.Developer", "Developer")
                        .WithOne()
                        .HasForeignKey("BusinessToDeveloper.Core.Entities.Project", "DeveloperId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("ForeignKey_DeveloperId");
